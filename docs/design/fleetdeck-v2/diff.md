...
| D18 | Landing | fixed nav (Deck¹⁴ · App · Registry · Certs · Docs · theme · Request access), hero (kickers, blurb, eyebrow, "Attach. Steer. Audit.", session widget "german-box · HOLDER OK · 12 ACTIVE · Open the deck"), 80vh spacer, Capability ("Registry On Demand", "Nothing runs unwatched.", 3 numbered cards), video-scrub canvas, reveal animations (L37-139, L969-1200) | none | L | P1 (free in S1) → P2 route (L1) | S1, L1 | P1 ✅ S1 `70c32bb` (gate 36/36, max 0.033 %) · P2 ✅ L11 `8f95eb2` (`/` → `?view=land` live) · L12 ✅ `453e57c` (static Range support; scrub live: video 0 → 4.99 → 9.98 s, three distinct frames; weave `9147462`) |
