...
| D18 | Landing | fixed nav (Deck¹⁴ · App · Registry · Certs · Docs · theme · Request access), hero (kickers, blurb, eyebrow, "Attach. Steer. Audit.", session widget "german-box · HOLDER OK · 12 ACTIVE · Open the deck"), 80vh spacer, Capability ("Registry On Demand", "Nothing runs unwatched.", 3 numbered cards), video-scrub canvas, reveal animations (L37-139, L969-1200) | none | L | P1 (free in S1) → P2 route (L1) | S1, L1 | P1 ✅ S1 `70c32bb` (gate 36/36, max 0.033 %) · P2 ✅ L11 `8f95eb2` (`/` → `?view=land` live) · rider L11.3 open (scroll-scrub video dead: server ignores Range, decisions.md 2026-09-07 late) |
