...
| D08 | Reply toast | bottom-right 340px, "{from} replied", preview, Open thread, 7s auto-dismiss (L769-780, L1473) | none | S | P1 → P2 (L6) | S1, L6 | P1 ✅ S1 `70c32bb` (gate 36/36, max 0.033 %) · P2 ✅ L6 `b4fd310` (fixture gate 36/36 max 0.033 %, live 47/47) |
