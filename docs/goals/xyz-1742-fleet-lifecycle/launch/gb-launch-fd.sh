...
ROLE=unknown; case $SLUG in edith) ROLE=backend-developer;; konrad) ROLE=devops-engineer;; alfons) ROLE=frontend-developer;; sylvia) ROLE=tooling-engineer;; dagmar) ROLE=frontend-developer;; esac
