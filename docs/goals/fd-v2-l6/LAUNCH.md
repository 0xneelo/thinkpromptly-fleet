...
Worker **Gerhild** (`frontend-developer`), Claude high, `/goal`, german-box. Session `FD-v2-l6`, worktree `~/projects/remote-system/.claude/worktrees/v2-l6`, branch `agent-v2-l6`, base `origin/agent-v2-s2`.
...
```bash
ssh german-box wsl sh /home/vibe/fd-launch-claude.sh Gerhild v2-l6 origin/agent-v2-s2
```
