...
Worker **Kunhild** (`frontend-developer`), Claude high, `/goal`, german-box. Session `FD-v2-l8`, worktree `~/projects/remote-system/.claude/worktrees/v2-l8`, branch `agent-v2-l8`, base `origin/agent-v2-s2`.
...
```bash
ssh german-box wsl sh /home/vibe/fd-launch-claude.sh Kunhild v2-l8 origin/agent-v2-s2
```
