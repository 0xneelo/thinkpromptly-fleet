...
- [x] `npm test` **green — 318/318, exit 0**; branch pushed; `REPORT.md` signed **Kunhild**; registry row `done` attempted — the endpoint answers HTTP 401 from this box (XYZ-2137).
