...
(function (global) {
  ...
  // that file's safety rig against audit F5: the observer is disconnected around our
  // own writes AND honours an `applying` flag, and applies are counted per macrotask
  ...
  function startToggle() {
    ...
    observer = new MutationObserver(function () { if (!applying) scheduleApply(); });
    observe();
    scheduleApply();
  }
